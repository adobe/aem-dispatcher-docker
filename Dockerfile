...
# Install HTTPD
RUN yum -y update && yum -y install httpd mod_ssl mod_security procps haproxy iputils less openssl && yum clean all

# Remove default httpd config
RUN rm -rf /etc/httpd/conf.d/* && rm -rf /etc/httpd/conf.modules.d/*
